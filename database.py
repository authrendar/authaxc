...
def init_db():
    ...
    safe_create_index(licenses_collection, [("app_id", 1), ("expires_at", 1)])
    safe_create_index(licenses_collection, [("app_id", 1), ("is_used", 1), ("is_banned", 1)])
    safe_create_index(licenses_collection, [("app_id", 1), ("created_at", -1)])
    safe_create_index(licenses_collection, [("app_id", 1), ("used_by", 1)])
    safe_create_index(licenses_collection, [("app_id", 1), ("hwid", 1)])
    safe_create_index(logs_collection, [("app_id", 1), ("timestamp", -1)])
    safe_create_index(sessions_collection, [("app_id", 1), ("session_id", 1)])
    safe_create_index(sessions_collection, [("app_id", 1), ("login_time", -1)])
